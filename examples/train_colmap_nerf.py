...
if __name__ == "__main__":
    ...
    parser.add_argument("--i_test",type=int, default=3000, help="Iterations to render test poses and create video") 
    ...
    testPoses = SubjectTestPoseLoader(subject_id=args.scene,root_fp=data_root_fp,numberOfFrames=30, downscale_factor=2)
    ...
    args.aabb = [dataset.aabb[0][0], dataset.aabb[0][1], -1, dataset.aabb[1][0], dataset.aabb[1][1], 1]
